...
| SagerNet | Android | https/quic | Inactive | [Client](https://github.com/SagerNet/SagerNet) & [Naive Plugin](https://github.com/klzgrad/naiveproxy/releases/latest) |
| Matsuri | Android | https/quic | Inactive | [Client](https://github.com/MatsuriDayo/Matsuri) & [Naive Plugin](https://github.com/klzgrad/naiveproxy/releases/latest) |
| NekoBoxForAndroid | Android | https/quic | Maintained | [Client](https://github.com/MatsuriDayo/NekoBoxForAndroid) & [Naive Plugin](https://github.com/klzgrad/naiveproxy/releases/latest) |
